...
- `site/public/terminal-demo.svg`: hand-authored SVG terminal recording of the bundled `flag-removal-map demo` output, created 2026-08-28 from the real command output; no third-party assets.
